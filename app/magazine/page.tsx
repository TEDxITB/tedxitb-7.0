...
const HeroSection = () => {
  return <section className="w-screen h-screen flex justify-center items-center relative">
    <Image
    ...
    <div className="flex flex-row z-10 w-3/4">
      <div className="flex flex-col justify-center">
        <p className="font-anderson mb-4">
          Magazine
        </p>
  ...
  return <section id="cover" className="bg-black w-screen p-20 [&>*]:bg-transparent flex flex-col gap-5 items-center z-10">
    <ul className="grid gap-5 grid-cols-4 grid-rows-3 max-w-7xl">
      {(new Array(12)).fill(0).map((_, i) => {
        return <li className="flex flex-col gap-2 cursor-pointer" key={i}>
