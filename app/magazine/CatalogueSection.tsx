...
export const CatalogueSection = (setMagazine: MagazineSetter) => {
    ...
    return <section id="cover" className="bg-black text-white font-anderson overflow-hidden w-screen py-7 px-10 flex flex-col gap-2 items-center z-10 relative">
        <Image
        ...
        >
            {(data).slice((showingPage - 1) * count, showingPage * count).map(magazine => <CoverSection key={magazine.title} {...{ magazine, setMagazine }} />
            )}
        </ul>
