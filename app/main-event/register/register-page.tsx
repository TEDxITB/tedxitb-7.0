...
function RegisterPage(props: { session: Session | null }) {
  ...
  return (
    <main className="bg-[#1E1E1E] font-anderson text-ted-white">
      <Form {...form}>
        <form className="relative mx-auto my-16 flex w-fit flex-col gap-12 overflow-hidden rounded-lg bg-[#1E1E1E] p-8 drop-shadow-[2px_4px_25px_rgba(75,75,75,0.5)] lg:gap-16 lg:p-16">
